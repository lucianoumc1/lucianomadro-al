...
export default function GithubIcon({ color = 'white', width = "25", height = "25", href }) {
  return (
    <a className='icon-container' target="blank" href={href}>
      <svg height={height} aria-hidden="true" viewBox="0 0 16 16" version="1.1" width={width} data-view-component="true" >
